...
#define STRING_CONFIG_H_AUTHOR "(jshipe, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hex Printer"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 50, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 5, 3.5 }
